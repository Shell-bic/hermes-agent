...
export const zh: Translations = {
  ...
  boot: {
    ...
    failure: {
      ...
      retry: '重试',
      approvedDesktopRequired: '请联系管理员部署经过批准的 Hermes Desktop 版本。',
      contactAdministrator: '请联系管理员处理后再重试。',
      managedFailure: 'Hermes Desktop 无法在企业管理模式下启动。',
      refreshEnterprisePolicy: '刷新企业策略',
      recoveryFailed: '企业恢复失败',
      recoveryFailedHint: '受管恢复操作未能完成。请打开日志并联系管理员。',
      retrySafeStop: '重试安全停止',
      repairInstall: '修复安装',
  ...
  enterpriseLogin: {
    ...
    passwordTab: '账号密码',
    weComTitle: '使用企业微信登录',
    weComDescription: '请使用企业微信扫描二维码，并在手机上确认登录。',
    preparingQr: '正在准备企业微信二维码…',
    pendingQr: '等待扫码确认',
    verifiedQr: '已在手机确认，正在登录…',
    expiredQr: '二维码已过期，请刷新后重新扫码。',
    deniedQr: '本次登录未获授权，请重试或联系企业管理员。',
    outOfScope: '当前企业微信账号无权使用此应用，请联系企业管理员。',
    gatewayOffline: '无法连接企业服务，请检查网络后重试。',
    genericQrError: '企业微信登录暂时无法完成，请刷新后重试。',
    passwordError: '账号或密码验证失败，请检查后重试。',
    expiresIn: seconds => `${seconds} 秒后过期`,
  ...
  skills: {
    ...
    noEnterpriseTitle: '未找到企业技能',
    noEnterpriseDesc: '尝试更宽泛的搜索词或其他分类。',
    enterpriseSignInTitle: '需要登录企业账号',
    enterpriseSignInDesc: '登录企业账号后可浏览并安装组织下发的技能。',
    enterpriseInstall: '安装',
    enterpriseInstalling: '安装中…',
    enterpriseInstalled: '已安装',
    enterpriseUpdateAvailable: '有新版',
    enterpriseUpdateUnsupported: '当前版本暂不支持更新。',
    enterpriseRevision: revision => `修订 ${revision}`,
    enterpriseFiles: count => `${count} 个文件`,
    enterpriseLoadFailed: '企业技能加载失败',
    enterpriseInstallFailed: name => `${name} 安装失败`,
    enterpriseInstallSucceeded: '企业技能安装成功',
    ...
    needsKeys: '需要密钥',
    bestFor: '适合场景',
    callableSchema: '当前会话工具',
    configuration: '配置要求',
    detailExamples: '示例问法',
    details: '详情',
    enterprisePolicyImpact: '企业策略影响',
    hideDetails: name => `收起 ${name} 详情`,
    includedTools: '包含工具',
    originalSkill: '原始 SKILL.md',
    rawSkillUnavailable: '这个条目暂时无法读取原始 SKILL.md。',
    riskBoundary: '风险边界',
    showDetails: name => `查看 ${name} 详情`,
    skillContentFailed: name => `读取 ${name} 的 SKILL.md 失败。`,
    skillContentLoading: '正在读取 SKILL.md...',
    skillUsage: '使用方式',
    statusMeaning: '状态含义',
    userControl: '用户可控性',
    policyStatus: {
