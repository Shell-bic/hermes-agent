...
export const ja = defineLocale({
  ...
  enterpriseLogin: {
    ...
    weComTab: 'WeCom QR コード',
    passwordTab: 'ユーザー名とパスワード',
    weComTitle: 'WeCom でサインイン',
    weComDescription: 'WeCom で QR コードをスキャンし、スマートフォンでサインインを確認してください。',
    preparingQr: 'WeCom QR コードを準備しています…',
    pendingQr: 'スキャンの確認を待っています',
    verifiedQr: 'スマートフォンで確認されました。サインイン中…',
    expiredQr: 'QR コードの有効期限が切れました。更新して再度スキャンしてください。',
    deniedQr: 'サインインは承認されませんでした。再試行するか管理者に連絡してください。',
    outOfScope: 'この WeCom アカウントはアプリを利用できません。管理者に連絡してください。',
    gatewayOffline: 'エンタープライズ サービスに接続できません。接続を確認して再試行してください。',
    genericQrError: 'WeCom サインインを完了できませんでした。更新して再試行してください。',
    passwordError: 'ユーザー名またはパスワードを確認できませんでした。確認して再試行してください。',
    expiresIn: seconds => `${seconds} 秒で期限切れ`,
  ...
  skills: {
    ...
    needsKeys: 'キーが必要',
    bestFor: '適した用途',
    callableSchema: '呼び出し可能なツール',
    configuration: '設定',
    detailExamples: '例',
    details: '詳細',
    enterprisePolicyImpact: 'ポリシーの影響',
    hideDetails: name => `${name} の詳細を閉じる`,
    includedTools: '含まれるツール',
    originalSkill: '元の SKILL.md',
    rawSkillUnavailable: 'この項目の元の SKILL.md は利用できません。',
    riskBoundary: 'リスク範囲',
    showDetails: name => `${name} の詳細を表示`,
    skillContentFailed: name => `${name} の SKILL.md を読み込めませんでした。`,
    skillContentLoading: 'SKILL.md を読み込み中...',
    skillUsage: '使い方',
    statusMeaning: '状態の意味',
    userControl: 'ユーザー制御',
    policyStatus: {
