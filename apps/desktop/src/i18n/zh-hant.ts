...
export const zhHant = defineLocale({
  ...
  boot: {
    ...
    failure: {
      ...
      retry: '重試',
      approvedDesktopRequired: '請聯絡管理員部署經核准的 Hermes Desktop 版本。',
      contactAdministrator: '請聯絡管理員處理後再重試。',
      managedFailure: 'Hermes Desktop 無法在企業管理模式下啟動。',
      refreshEnterprisePolicy: '重新整理企業原則',
      recoveryFailed: '企業復原失敗',
      recoveryFailedHint: '受管復原操作未能完成。請開啟記錄並聯絡管理員。',
      retrySafeStop: '重試安全停止',
      repairInstall: '修復安裝',
  ...
  enterpriseLogin: {
    ...
    passwordTab: '帳號密碼',
    weComTitle: '使用企業微信登入',
    weComDescription: '請使用企業微信掃描 QR 碼，並在手機上確認登入。',
    preparingQr: '正在準備企業微信 QR 碼…',
    pendingQr: '等待掃碼確認',
    verifiedQr: '已在手機確認，正在登入…',
    expiredQr: 'QR 碼已過期，請重新整理後再次掃描。',
    deniedQr: '本次登入未獲授權，請重試或聯絡企業管理員。',
    outOfScope: '目前企業微信帳號無權使用此應用程式，請聯絡企業管理員。',
    gatewayOffline: '無法連線企業服務，請檢查網路後重試。',
    genericQrError: '企業微信登入暫時無法完成，請重新整理後重試。',
    passwordError: '帳號或密碼驗證失敗，請檢查後重試。',
    expiresIn: seconds => `${seconds} 秒後過期`,
  ...
  skills: {
    ...
    needsKeys: '需要金鑰',
    bestFor: '適合場景',
    callableSchema: '目前會話工具',
    configuration: '設定要求',
    detailExamples: '範例問法',
    details: '詳情',
    enterprisePolicyImpact: '企業策略影響',
    hideDetails: name => `收起 ${name} 詳情`,
    includedTools: '包含工具',
    originalSkill: '原始 SKILL.md',
    rawSkillUnavailable: '此項目暫時無法讀取原始 SKILL.md。',
    riskBoundary: '風險邊界',
    showDetails: name => `查看 ${name} 詳情`,
    skillContentFailed: name => `讀取 ${name} 的 SKILL.md 失敗。`,
    skillContentLoading: '正在讀取 SKILL.md...',
    skillUsage: '使用方式',
    statusMeaning: '狀態含義',
    userControl: '使用者可控性',
    policyStatus: {
