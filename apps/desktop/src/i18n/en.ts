...
export const en: Translations = {
  ...
  enterpriseLogin: {
    ...
    weComTab: 'WeCom QR code',
    passwordTab: 'Username and password',
    weComTitle: 'Sign in with WeCom',
    weComDescription: 'Scan the QR code with WeCom, then confirm sign-in on your phone.',
    preparingQr: 'Preparing the WeCom QR code…',
    pendingQr: 'Waiting for scan confirmation',
    verifiedQr: 'Confirmed on your phone. Signing in…',
    expiredQr: 'This QR code expired. Refresh it to scan again.',
    deniedQr: 'This sign-in was not authorized. Try again or contact your administrator.',
    outOfScope: 'This WeCom account cannot use the application. Contact your administrator.',
    gatewayOffline: 'The enterprise service is unreachable. Check your connection and retry.',
    genericQrError: 'WeCom sign-in could not be completed. Refresh and try again.',
    passwordError: 'The username or password could not be verified. Check them and try again.',
    expiresIn: seconds => `Expires in ${seconds}s`,
  ...
  skills: {
    tabSkills: 'Guidance',
    tabToolsets: 'Tools',
    tabEnterprise: 'Enterprise Discovery',
    all: 'All',
    searchSkills: 'Search skills...',
    searchToolsets: 'Search toolsets...',
    searchEnterprise: 'Search enterprise skills...',
    ...
    noEnterpriseTitle: 'No enterprise skills found',
    noEnterpriseDesc: 'Try a broader search or another category.',
    enterpriseSignInTitle: 'Enterprise sign-in required',
    enterpriseSignInDesc: 'Sign in to your enterprise account to browse and install organization skills.',
    enterpriseInstall: 'Install',
    enterpriseInstalling: 'Installing…',
    enterpriseInstalled: 'Installed',
    enterpriseUpdateAvailable: 'New version',
    enterpriseUpdateUnsupported: 'Updates are not supported in this release.',
    enterpriseRevision: revision => `Revision ${revision}`,
    enterpriseFiles: count => `${count} ${count === 1 ? 'file' : 'files'}`,
    enterpriseLoadFailed: 'Enterprise skills failed to load',
    enterpriseInstallFailed: name => `Failed to install ${name}`,
    enterpriseInstallSucceeded: 'Enterprise skill installed',
    ...
    bestFor: 'Best for',
    callableSchema: 'Callable tools',
    configuration: 'Configuration',
    detailExamples: 'Example prompts',
    details: 'Details',
    enterprisePolicyImpact: 'Policy impact',
    hideDetails: name => `Hide details for ${name}`,
    includedTools: 'Included tools',
    originalSkill: 'Original SKILL.md',
    rawSkillUnavailable: 'The original SKILL.md is unavailable for this entry.',
    riskBoundary: 'Risk boundary',
    showDetails: name => `Show details for ${name}`,
    skillContentFailed: name => `Failed to load SKILL.md for ${name}.`,
    skillContentLoading: 'Loading SKILL.md...',
    skillUsage: 'How to use',
