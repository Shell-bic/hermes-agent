 ...
 *
 * A public install can end up with `origin=git@github.com:Shell-bic/hermes-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/Shell-bic/hermes-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/shell-bic/hermes-agent'
